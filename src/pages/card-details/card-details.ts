...
import {ViewPaymentPage} from "../view-payment/view-payment";
...
export class CardDetails {
  ...
  constructor(public NavCtrl: NavController, public navPrms: NavParams, public toastCtrl: ToastController) {
    this.journeyDetails = navPrms.get('journeyDetails');
    this.passengerDetails = navPrms.get('passengerDetails');
